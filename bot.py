...
async def info():
    ...
    await bot.say(f"Hi, I'm QuestBot.  Add me to your server: {<a href="[Invite link]"> https://discordapp.com/oauth2/authorize?client_id=469366032176381952&scope=bot</a>}")
